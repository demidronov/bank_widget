...
class TestGetMaskCardNumber:
    """Test suite for get_mask_card_number function."""
    ...
    def test_short_card_numbers(self, card_number: str, expected: str) -> None:
    ...
    def test_card_numbers_with_formatting(
        self, card_number: str, expected: str
    ) -> None:
        """Test that card numbers with formatting are handled correctly."""
        result = get_mask_card_number(card_number)
        assert result == expected

    def test_card_number_with_fixture(self, sample_card_numbers: list[tuple[str, str]]) -> None:
    ...
    def test_edge_cases_with_fixture(
        self, edge_case_card_numbers: list[tuple[str, str]]
    ) -> None:
...
class TestGetMaskAccount:
    """Test suite for get_mask_account function."""
    ...
    def test_short_account_numbers(
        self, account_number: str, expected: str
    ) -> None:
    ...
    def test_account_numbers_with_formatting(
        self, account_number: str, expected: str
    ) -> None:
    ...
    def test_account_number_with_fixture(
        self, sample_account_numbers: list[tuple[str, str]]
    ) -> None:
    ...
    def test_edge_cases_with_fixture(
        self, edge_case_account_numbers: list[tuple[str, str]]
    ) -> None:
        """Test edge cases using fixture data."""
